...
\label{letteringDetection}
	...
	\subsection{Defect Detection Method}
		...
		\end{figure}
		\begin{figure}[H]
			\subfigure[Aligned Reference Image]
			{
				\includegraphics[width=0.33\linewidth]{aligned_reference.png}
			}
			
			\subfigure[Aligned Sample Image]
			{
				\includegraphics[width=0.33\linewidth]{aligned_sample.png}
			}
			\subfigure[Absolute Difference Result Image]
			{
				\includegraphics[width=0.33\linewidth]{abs_diff_result.png}
			}
